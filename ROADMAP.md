...
- [ ] CI: матрица Python 3.9–3.13, lint+type+test, сборка.
- [ ] Публикация на PyPI через trusted publishing (TestPyPI → PyPI).
- [ ] Бейджи, страница на PyPI, базовая docs-страница.
